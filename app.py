...
# --- Database Config ---
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("postgresql://chama_db_xq7q_user:HB5iq1bpehxfinPeGl7UaRFcRoqIIS98@dpg-d2qicln5r7bs73anuuv0-a/chama_db_xq7q","sqlite:///chama.db")  # set in Render
